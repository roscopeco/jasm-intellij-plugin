...
class MethodSubtree(node: ASTNode) : IdentifierDefSubtree(node, RULE_ELEMENT_TYPES[JasmParser.RULE_membername]), ScopeNode {
    override fun resolve(element: PsiNamedElement?): PsiElement?
        = SymtabUtils.resolve(this, JasmLanguage.INSTANCE, element,"method//membername")
}